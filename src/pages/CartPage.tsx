          ...
          <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) => setDeliveryDetails({...deliveryDetails, deliveryType: e.target.value as 'delivery' | 'pickup'})}
                    className="mr-2"
                  />
                  Entrega
                </label>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setDeliveryDetails({...deliveryDetails, paymentMethod: e.target.value as DeliveryDetails['paymentMethod']})}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500"
              >
